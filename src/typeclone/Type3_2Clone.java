...
public class Type3_2Clone {
	...
	public static void main(String[] args) throws IOException {
		...
		String resultPath = "/media/misu/MS/Masters/PaperDataset/SF110/SF110project_CloneResult_Type3-2.csv";
		...
		for (String projectName : projectList) {
			...
			String type3_2ClonePairXMLPath = basePath + projectName + "/"
					+ projectName + "-type3-2.xml";
			;
